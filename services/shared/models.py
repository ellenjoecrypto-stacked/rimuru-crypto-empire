...
class IndicatorResult(BaseModel):
    ...
    rsi: float | None = None
    macd: dict | None = None  # {macd, signal, histogram}
    bollinger: dict | None = None  # {lower, middle, upper, width}
    atr: float | None = None
    stochastic: dict | None = None  # {k, d, overbought, oversold, bullish_cross, bearish_cross}
    adx: dict | None = None  # {adx, plus_di, minus_di, strong_trend, bullish}
    vwap: dict | None = None  # {vwap, deviation_pct, above_vwap}
